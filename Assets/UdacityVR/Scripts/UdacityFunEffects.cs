...
public class UdacityFunEffects : MonoBehaviour {
    ...
    {
        Color c = UnityEngine.Random.ColorHSV(0f, 1f, 0f, 1f, 0f, 1f, 1f, 1f);
    ...
    {
        if (!isSunUp)
            text.text = "I demand sunlight!";
        else
            text.text = "I thirst for blood, make it night!";
    }
    ...
    private IEnumerator SpawnCubesWithDelay()
    {
        for (int i = 0; i < cubes.Length; i++)
        {
            ...
            cubes[i].transform.position = new Vector3(UnityEngine.Random.Range(-2f, 2f), 25f, Random.Range(-2f, 2f));
